			...
			<div className="container">
				...
				<div className="footer__bottom">
					<div className="copyright-text">
						{ copyrightText ? (
							<a href="/" target="_blank" rel="noreferrer">{ copyrightText }</a>
						) : (
							<a href="/" target="_blank" rel="noreferrer">footer copyright</a>
						) }
					</div>
...
Footer.defaultProps = {
	copyrightText: `Gary Tietjen ${ new Date().getFullYear() }`,
};
